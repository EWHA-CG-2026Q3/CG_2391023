...
public class S06_SoftwareRasterizer_Finish : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 vertexB = new Vector2(90, 40);
    [SerializeField] private Vector2 vertexC = new Vector2(166, 40);
    [SerializeField] private Color fillColor = new Color(1f, 1f, 0f, 1f);
